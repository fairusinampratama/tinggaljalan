    ...
    <section className="bg-brandDark px-4 py-14 text-white sm:px-8 lg:px-10">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-2xl">
          <p className="mb-3 text-xs font-black uppercase tracking-[0.2em] text-brandBlue">{t.ctaEyebrow}</p>
          <h2 className="font-display text-4xl font-black leading-none sm:text-5xl">{t.ctaTitle}</h2>
