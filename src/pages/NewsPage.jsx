...
import { getFeaturedNewsArticles, getNewsByFilters, newsArticles } from '../data/news';
...
export function NewsPage() {
  ...
  const { featured, latest } = getFeaturedNewsArticles();
  ...
  const filteredArticles = useMemo(
    ...
    [categoryFilter, destinationFilter, language, searchTerm],
  );
          ...
          <div className="mb-8 grid gap-5 lg:grid-cols-[minmax(0,0.95fr)_minmax(320px,0.55fr)] lg:items-end">
            ...
            <div className="rounded-2xl border border-brandLine bg-white p-5 shadow-soft">
              ...
              <div className="mt-4 grid grid-cols-3 gap-3 text-center">
                {[
                  { value: newsArticles.length, label: language === 'id' ? 'Artikel' : 'Articles' },
                  { value: 4, label: language === 'id' ? 'Destinasi' : 'Destinations' },
