...
class BookingPaymentReceiptMail extends Mailable
{
    ...
    public function build(): self
    {
        return $this
            ...
            ->subject(BookingLanguage::translate('booking.receipt_subject', ['code' => $this->payment->booking->booking_code], $this->payment->booking->communication_language))
            ->view('emails.booking-payment-receipt')
            ->text('emails.booking-payment-receipt-text');
    }
}
